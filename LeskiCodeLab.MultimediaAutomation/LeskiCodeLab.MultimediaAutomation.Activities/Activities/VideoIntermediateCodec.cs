...
{
    [LocalizedDisplayName(nameof(Resources.VideoIntermediateCodec_DisplayName))]
    [LocalizedDescription(nameof(Resources.VideoIntermediateCodec_Description))]
    public class VideoIntermediateCodec : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        public void Execute()
        {
            ...
            var inputFile = @"D:\Scratchdisk\input.mov";
