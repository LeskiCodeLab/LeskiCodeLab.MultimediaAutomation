...
{
    [LocalizedDisplayName(nameof(Resources.VideoDenoise_DisplayName))]
    [LocalizedDescription(nameof(Resources.VideoDenoise_Description))]
    public class VideoDenoise : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        public void Execute()
        {
            ...
            var command = "-vf fftdnoiz=30:1:6:0.5:1:1 -vcodec prores_ks -profile:v 3";
            var FFMPEGDirectory = FFMPEGPath.Substring(0, FFMPEGPath.LastIndexOf('\\'));
