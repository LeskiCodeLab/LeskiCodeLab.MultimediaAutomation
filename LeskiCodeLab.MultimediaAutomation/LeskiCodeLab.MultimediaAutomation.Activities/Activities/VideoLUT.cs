...
{
    [LocalizedDisplayName(nameof(Resources.VideoLUT_DisplayName))]
    [LocalizedDescription(nameof(Resources.VideoLUT_Description))]
    public class VideoLUT : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        public void Execute()
        {
            ...
            var lutFile = @"D:\Scratchdisk\2Strip.cube";
            //var lutFile = @"D\\:/Scratchdisk/2Strip.cube";
