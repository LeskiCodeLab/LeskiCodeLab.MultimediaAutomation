...
{
    [LocalizedDisplayName(nameof(Resources.MultimediaProcess_DisplayName))]
    [LocalizedDescription(nameof(Resources.MultimediaProcess_Description))]
    public class MultimediaProcess : ContinuableAsyncCodeActivity
    {
        #region Properties
